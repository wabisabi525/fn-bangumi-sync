...
class WebUiContractTests(unittest.TestCase):
    def test_template_contains_linked_boot_switch(self):
        ...
        self.assertIn('sidebar-collapsing', html)
        self.assertIn('sidebar-expanding', html)
        self.assertIn('width: 46px; height: 46px', html)
        self.assertIn('min-height: 38px', html)
        self.assertIn('sidebarAnimationTimer', html)
